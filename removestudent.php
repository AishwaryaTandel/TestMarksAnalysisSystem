...
$sql1="select * from $class where student_name='$sname' and rollno='$rollno'";
$sql="delete from $class where student_name='$sname' and rollno='$rollno'";
$result=mysqli_query($conn,$sql1);
$row=mysqli_fetch_array($result);
if($row && mysqli_query($conn,$sql)){
	echo "<center><h1>Student details removed successfully!</h1></center>";
}
else{
	echo "<center><h1>Error! No such entry found!</h1></center>";
}
?>